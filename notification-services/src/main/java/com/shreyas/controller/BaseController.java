...
public class BaseController {
    ...
    protected ResponseEntity<APIResponse<Void>> CreatedResponse(String message) {
    ...
    protected <T> ResponseEntity<APIResponse<T>> CreatedResponse(String message, T body) {
        log.info("Returning created response with body: {}", body);
        APIResponse<T> response = new APIResponse<>("SUCCESS", body, message, HttpStatus.CREATED);
        return new ResponseEntity<>(response, getJsonHeaders(), HttpStatus.CREATED);
    }
