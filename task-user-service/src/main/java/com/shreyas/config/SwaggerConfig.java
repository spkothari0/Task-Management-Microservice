...
import com.shreyas.filter.correlation.CorrelationIdCustomizer;
...
@OpenAPIDefinition(info = @Info(
        title = "Task User Services",
        version = "1.0",
        description = "API documentation for User Services of Task Management project",
...
public class SwaggerConfig {
    ...
    public GroupedOpenApi customApi() {
        return GroupedOpenApi.builder()
                .group("custom-api")
                .packagesToScan("com.shreyas.controller") // Specify your controllers' package
